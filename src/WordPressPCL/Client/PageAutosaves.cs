...
public class PageAutosaves
{
    ...
    /// </summary>
    /// <param name="page">The page data to autosave</param>
    /// <param name="cancellationToken">Cancellation token</param>
    ...
    {
        string json = AutosaveSerializer.Serialize(page, _httpHelper.JsonSerializerOptions);
