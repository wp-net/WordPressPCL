...
namespace WordPressPCL.Tests.Selfhosted.Utility
{
    ...
    "MailPress_edit_dashboard": true,
    "MailPress_manage_options": true,
    "MailPress_edit_mails": true,
    "MailPress_edit_others_mails": true,
    "MailPress_send_mails": true,
    "MailPress_delete_mails": true,
    "MailPress_archive_mails": true,
    "MailPress_mail_custom_fields": true,
    "MailPress_switch_themes": true,
    "MailPress_edit_users": true,
    "MailPress_delete_users": true,
    "MailPress_user_custom_fields": true,
    "MailPress_manage_addons": true,
    "MailPress_manage_autoresponders": true,
    "MailPress_manage_newsletters": true,
    "MailPress_test_newsletters": true,
    "picasa_dialog": true,
    "wysija_newsletters": true,
    "wysija_subscribers": true,
    "wysija_config": true,
    "wysija_theme_tab": true,
    "wysija_style_tab": true,
    "wysija_stats_dashboard": true,
    "aiosp_manage_seo": true,
    "see_snap_box": true,
    "make_snap_posts": true,
    "wpseo_bulk_edit": true,
    "wpseo_manage_options": true,
    "haveown_snap_accss": true,
    "administrator": "1"
  }*/
