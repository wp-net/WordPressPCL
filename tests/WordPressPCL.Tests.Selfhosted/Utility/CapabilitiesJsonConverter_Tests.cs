...
public class CapabilitiesJsonConverter_Tests
{
    ...
    private static JsonSerializerOptions CreateOptions()
    {
        ...
        options.Converters.Add(new CapabilitiesDictionaryConverter());
        return options;
    }
    ...
    {
        Dictionary<string, bool>? result = JsonSerializer.Deserialize<Dictionary<string, bool>>(TestData1, CreateOptions());
    ...
    {
        Assert.ThrowsExactly<FormatException>(() => JsonSerializer.Deserialize<Dictionary<string, bool>>(BadTestData1, CreateOptions()));
    }
